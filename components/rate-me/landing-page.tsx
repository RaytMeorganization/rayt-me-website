...
const pillars = [
  {
    ...
    title: "Titles change. Printed cards don't.",
    copy: "Your RaytME card updates instantly — no reprints, ever.",
  },
  {
    num: "02",
    eyebrow: "TURN CONTACTS INTO A NETWORK",
    title: "Stop losing business cards.",
    copy: "Save everyone you meet, searchable by profession, whenever you need them.",
  },
  {
    num: "03",
    eyebrow: "TRACK GROWTH, NOT GUESSWORK",
    title: "Reviews rely on memory.",
    copy: "RaytME gives HR a real, running score built from real ratings.",
  },
  {
    num: "04",
    eyebrow: "BUILD TRUST ACROSS ANY BORDER",
    title: "Never met in person?",
    copy: "Share your code, rate the work, build trust with zero distance.",
  },
  {
    num: "05",
    eyebrow: "BE CREDIBLE THE MOMENT IT COUNTS",
    title: "Credibility that shows up late is useless.",
    copy: "RaytME makes yours visible the moment it matters.",
  },
  {
    num: "06",
    eyebrow: "SEE THE FULL PICTURE, NOT ONE SCORE",
    title: "One star hides everything.",
    copy: "RaytME scores five categories — so your real strengths actually show.",
  },
  {
    num: "07",
    eyebrow: "GET HONEST FEEDBACK, WITHOUT THE FEAR",
    title: "Named feedback gets softened.",
    copy: "Anonymous ratings on RaytME stay honest — and still count.",
  },
  {
    num: "08",
    eyebrow: "RATINGS YOU CAN ACTUALLY TRUST",
    title: "Rating systems get gamed.",
    copy: "RaytME blocks rings, fake reviews, and flood attempts — automatically.",
  },
  {
    num: "09",
    eyebrow: "MAKE EVERY RATING COUNT",
    title: "Endorsements don't change behavior.",
    copy: "Real, visible ratings do — every time, everywhere.",
  },
  {
    num: "10",
