...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    ...(!WEB_SIGN_UP_DISABLED
      ...
      : []),
    { url: 'https://rate.me/privacy', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.3 },
    { url: 'https://rate.me/terms', lastModified: new Date(), changeFrequency: 'monthly', priority: 0.3 },
