  ...
  return (
    ...
    >
      <body className="antialiased">
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ '@context': 'https://schema.org', '@graph': [{ '@type': 'Organization', name: 'RaytME', url: 'https://rate.me', description: 'Your virtual business card, with a portable professional reputation.' }, { '@type': 'SoftwareApplication', name: 'RaytME', applicationCategory: 'BusinessApplication', operatingSystem: 'iOS, Android, Web', description: 'A virtual business card and portable professional reputation profile you can share by link, QR, or email signature.' }, { '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: 'What is RaytME?', acceptedAnswer: { '@type': 'Answer', text: 'RaytME is your virtual business card and portable professional reputation. Share one profile and keep your details and ratings current.' } }, { '@type': 'Question', name: 'Can I dispute a rating?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. Rated users can flag a rating for review and respond publicly.' } }] }] }) }} />
