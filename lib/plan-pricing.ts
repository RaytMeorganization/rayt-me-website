/** Public marketing prices — keep in sync with landing pricing and backend seed. */
export const USD_PRO_YEAR = 27
export const USD_PER_EMPLOYEE_YEAR = 16
...
export const MARKETING_PLANS: MarketingPlanDefinition[] = [
  ...
  { code: 'business', name: 'BUSINESS', priceCents: USD_PER_EMPLOYEE_YEAR * 100, period: 'employeeYear' },
]
